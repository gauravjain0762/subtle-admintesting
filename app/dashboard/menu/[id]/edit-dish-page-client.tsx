...
import { ArrowLeft, Save, Check, ChevronDown, Star, ShoppingBag, Plus, Trash2 } from "lucide-react";
import { toast } from "sonner";
import { getDish, getDishIds, updateDish, type Dish, type Ingredient, AVAILABLE_TAGS, EMOJI_OPTIONS, TAG_COLORS } from "@/lib/menu-store";
...
export default function EditDishPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [form, setForm]     = useState<{
    ...
    menuId: string; ingredients: Ingredient[];
  } | null>(null);
